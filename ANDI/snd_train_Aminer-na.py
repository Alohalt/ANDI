...
class SNDTrainer:
    def __init__(self, w_author=1.5, w_org=1.0, w_venue=1.0, w_title=0.33,
        ...
        self.processed_data_root = f'./gene/{args.dataset}'
        self.raw_data_root = f'/home/liutao/workspace/AND/dataset/{args.dataset}'
    ...
    def save_pair(self,pubs, name, outlier):
        ...
        """
        dirpath = join('./gene', self.dataset, self.data_type, name)
...
if __name__ == "__main__":
    ...
    args.val = True
    args.test = False
    args.dataset = 'Aminer-na'
    # args.feature_type = 'word2vec'

    processed_data_root = f'./gene/{args.dataset}'
    raw_data_root = f'/home/liutao/workspace/AND/dataset/{args.dataset}'
    ...
    if args.val:
        ...
        for text_weight in [1, 1.5, 2]:
            for eps in [0.3, 0.35, 0.4]:
                trainer = SNDTrainer(text_weight=text_weight, db_eps=eps, db_min=4, num_walk=5, walk_len=15)  #
